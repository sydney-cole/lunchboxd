...
- [x] 02-05-PLAN.md — Web review list page, ReviewCard, edit page, delete dialog, FAB
- [x] 02-06-PLAN.md — Mobile (Expo) review composer with native components
...
- [x] 03-02-PLAN.md — Follow/unfollow API routes with friendship detection and userStats
- [x] 03-03-PLAN.md — Like toggle API and reviews GET extension with like data
...
**Wave 1** *(blocked on Wave 0 completion)*:
- [x] 04-02-PLAN.md — GET /api/v1/feed cursor-paginated endpoint
...
- [x] 05-02-PLAN.md — GET /api/v1/users/[username], PATCH /api/v1/users/me, GET /api/v1/users/[username]/reviews
